function [decision, frame_next] = VFMW_non_idling(current_location, pressure, frame_remained, average_rate, beta)
...
% pressure: pressure matrix of dimension nLink-by-1
    ...
    if current_location > 0
        if frame_remained > 0 && pressure(current_location) > 0
