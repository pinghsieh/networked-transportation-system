function [decision, frame_next] = VFMaxHoL_Adhoc_ext(nPhase, feasible_phase, current_location, current_jobs, frame_remained, age, lambda_matrix)
...
% pressure: pressure matrix of dimension nLink-by-1
    ...
    for i=1:nPhase
        weight(i) = sum(age(feasible_phase{i}).*lambda_matrix{i});
