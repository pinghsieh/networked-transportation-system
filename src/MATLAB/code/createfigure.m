...
plot1 = plot(X1,YMatrix1,'LineWidth',4, 'Markersize', 10);
set(plot1(1), 'Marker', 'x', 'Color', 'magenta', 'LineStyle', '-', 'DisplayName','Phase 1');
%set(plot1(2), 'Marker', 'o', 'Color', 'green', 'LineStyle', '-', 'DisplayName','Phase 2');
