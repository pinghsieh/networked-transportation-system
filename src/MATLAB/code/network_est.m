...
%    network_est.m | An isolated intersection with multilpe entry links
%
%    Instructions
%    ------------
% 
...
prob_arrival = [0.45; 0.45; 0.045; 0.045];
%prob_arrival = [0.333; 0.333; 0.05; 0.05];
%prob_arrival = [0.2; 0.2; 0.04; 0.04];
%prob_arrival = [0.245; 0.245];
%prob_arrival = [0.49; 0.245];
IDLE_MAX = 1;
