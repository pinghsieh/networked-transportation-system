...
%    network_det.m | An isolated intersection with multilpe entry links and
...
nLink = 4;
%nLink = 2;
period_arrival = [5; 5; 5; 5];
%period_arrival = [3; 3; 20; 20];
...
prob_on_channel = [1; 1; 1; 1]; % deterministic flows
...
for i = 1:iteration
    ...
    for t = 1:simT
        ...
        % New arrivals
        current_jobs = current_jobs + (mod(t, period_arrival) == 1);
