...
%    network_adhoc.m | An isolated intersection with multilpe entry links
...
for i = 1:iteration
    ...
    for t = 1:simT
        ...
        [decision, frame_remained] = VFMaxHoL_Adhoc(nPhase, feasible_phase, server_location, current_jobs, frame_remained, HoL_age, lambda);
