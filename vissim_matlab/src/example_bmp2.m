...
%vissim_com.LoadNet('C:\Users\jiaojian\Desktop\JAN\timevar_pattern2.inp');
vissim_com.LoadNet('C:\Users\jiaojian\Desktop\JAN\2400_net.inp');
...
%% File I/O
QL_Log_ID = fopen('queue_length_debug2.log', 'w');
Pressure_Log_ID = fopen('pressure_debug2.log', 'w');
Pressure_Log_Node1_ID = fopen('pressure_node1_debug2.log', 'w');
QL_Log_Node1_ID = fopen('queue_length_node1_debug2.log', 'w');
Total_QL_Log_ID = fopen('total_queue_length2.log', 'w');
Pressure_Log_Node4_ID = fopen('pressure_node4_debug2.log', 'w');
QL_Log_Node4_ID = fopen('queue_length_node4_debug2.log', 'w');
